...
public class Main {
   ...
   private static double calcGPA(double korean_point, double english_point, double computer_point ) {
	  
	   return (double)(korean_point+english_point+computer_point)/3.0;
   }
